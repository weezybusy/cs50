...
int main(int argc, char* argv[])
{
	...
	if (n < 0 || n > 100)
	{
		printf("n must be greater than 0 and smaller or equal to 100\n");
		return 2;
	}
...
/****************************** UPDATE HEADERS *******************************/
	...
	int out_pad = (4 - (oi.biWidth * sizeof(RGBTRIPLE)) % 4) % 4;

	// biSizeImage
	oi.biSizeImage = (oi.biWidth * sizeof(RGBTRIPLE) + out_pad) *
		          abs(out_bi.biHeight);
	// bfSize
	of.bfSize = biSizeImage + HEADERS_SIZE;
